...
const ModularFormTest = (/*{ handleSubmit }: { handleSubmit: SubmitHandler<ModularFormData> }*/) => {
  ...
  return (
    <Text>
      @modular-form was temporarily removed because overrides don't work in NPM workspaces:{' '}
      <a href="https://github.com/npm/cli/issues/4834">BUG</a>. Additionally, @modular-forms still has not updated to
      React 19 and is incompatible with it.
    </Text>
