...
describe('Tooltipped', () => {
  ...
  describe('hiding/showing', () => {
    test('tootip should show on mouse over', async () => {
      ...
      expect(
        container.querySelector('.jtjs-tooltip[aria-hidden="false"]')
      ).not.toBeNull();
    });
    ...
    test('tooltip should disappear on mouse leave', async () => {
      ...
      expect(
        container.querySelector('.jtjs-tooltip[aria-hidden="true"]')
      ).not.toBeNull();
    });
  ...
  describe('wrapper swapping', () => {
    test('is div by default', () => {
      ...
      expect(
        container.querySelector('div.jtjs-tooltip-container')
      ).not.toBeNull();
    });
    ...
    test('is span if inline === true', () => {
      ...
      expect(
        container.querySelector('span.jtjs-tooltip-container')
      ).not.toBeNull();
    });
  });
});
